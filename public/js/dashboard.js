...
userPosts.innerHTML = `
    <form class="max-w-sm mx-auto bg-gray-700 rounded p-2 my-2">
    <div>
    ...
    <div class="mb-5">
     ...
     <input id="submit-btn" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" value="Create">
